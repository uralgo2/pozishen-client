                    ...
                    <div className='projects'>
                        <div className='projects-table'>
                            ...
                            <div className='projects-body'>
                            {
                                projects.map(project => {
                                    ...
                                    const collectionDate = project.lastCollection?.toLocaleTimeString('ru', {
                                        month: '2-digit',
                                        day: '2-digit',
                                    })
                                    ...
                                    return <div className='project'>
                                        ...
                                        } className={`marker ${project.marker}`}/>
                                        <div className='name'>
                                            <span className='site-name'>{project.siteAddress}</span>
                                            <div className='right'>
                                                <svg className='settings' width="24" height="24" viewBox="0 0 24 24"
                                                ...
                                                <svg onClick={() => setProjects(projects.filter(p => p.id !== project.id))} className='delete' width="22" height="22" viewBox="0 0 22 22"
                                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                        ...
                        <div className='buttons'>
                            ...
                            <button className='download-program button'>
                                ...
                                <span className='text'>Скачать&nbsp;программу</span>
                            </button>
                        </div>
                    </div>
                </div>
